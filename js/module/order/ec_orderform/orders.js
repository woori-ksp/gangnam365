EC$(function() {
    ...
    EC$('#all_use_mileage, #all_use_deposit').off().on('click', function() {
        ...
        var total_mileage = parseInt(CAFE24.SHOP_FRONT_ORDERFORM_DATA.mileage.fMaxMileage);
        var total_deposit = parseInt(CAFE24.SHOP_FRONT_ORDERFORM_DATA.deposit.fMaxDeposit);
...
function viewRegularDelivery() {
    window.open('/order/ec_orderform/agreement/regular_delivery.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640');
}
...
function viewMallAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/mallagree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//비회원 구매시 개인정보수집이용동의
function viewPersonAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/personagree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//청약철회방침 보기
function viewSubscription() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/subscription.html?basket_type='+EC$('#basket_type').val(), '', 'width=640,height=350');
    }
}
//전자보증보험 보기
function viewInsurance() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/insurance.html?basket_type='+EC$('#basket_type').val() +'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//Daum 비회원 구매 동의 보기
function viewDaum() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/daum.html?basket_type='+EC$('#basket_type').val(), '', 'width=640,height=350');
    }
}
//배송정보 제공방침 동의
function viewDelivery() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/delivery.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//고유식별정보수집 동의
function viewIdentification() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/identification.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//개인정보수집 이용동의
function viewMemberJoinAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/privacy_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//개인정보 제3자 제공 동의
function viewInformationAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/information_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//개인정보취급 위탁 동의
function viewConsignmentAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/consignment_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
//예약결제 이용 동의
function viewCrowdfunding() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/agreement/crowdfunding.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
function viewSafePhone() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/ec_orderform/popup/safePhone.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=467');
    }
}
...
function viewPaymentAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/protected/order/payment_agree_financial.html', '', 'width=640,height=350');
    }
}

// 개인정보 수집 및 이용 동의(선택)
function viewPrivacyOptionalAgree() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/privacy_optional_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/privacy_optional_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}

// 개인정보 수집 및 이용 동의 (주문서 간단 회원가입 시)
function viewPrivacySimpleOrderAgree() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/privacy_simple_order_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/privacy_simple_order_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}

// 개인정보 제3자 제공 동의
function viewThirdPartyProvideAgree() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/third_party_provide_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/third_party_provide_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}

// 개인정보 처리 위탁 동의
function viewConsignmentProcessingAgree() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/consignment_processing_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/consignment_processing_agree.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}

//마케팅 목적의 개인정보 수집 및 이용 약관
function viewMarketingAgree() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/marketing_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/marketing_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}

// 사용자 지정 N개 항목 추가 동의 항목 약관
function viewUserDefinedAgree(iAgreementNo) {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/user_defined_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val()+'&agreement_no='+iAgreementNo);
    } else {
        window.open('/order/ec_orderform/agreement/user_defined_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val()+'&agreement_no='+iAgreementNo, '', 'width=640,height=350');
    }
}
...
function viewReservation() {
    if (EC_MOBILE_DEVICE == true) {
        window.open('/order/ec_orderform/agreement/reservation_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val());
    } else {
        window.open('/order/ec_orderform/agreement/reservation_agreement.html?basket_type='+EC$('#basket_type').val()+'&delvtype='+EC$('#delvType').val(), '', 'width=640,height=350');
    }
}
